                ...
                <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
                    ...
                    <div className="order-2 md:order-1">
                        <h1 className="text-4xl md:text-5xl font-bold leading-tight text-gray-900">
                            Start Your Defence Journey with {" "}
                            <span className="text-green-600"> RK Defence Academy</span>
                        </h1>

                        <p className="mt-6 text-gray-600 text-lg">
                            Join RK Defence Academy and prepare for SSC GD, AGNIVEER,
                            CISF, CRPF, and RPF with disciplined training, expert guidance,
                            and proven results.
                        </p>
                ...
                <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 mt-6 text-lg">
                            <span className="text-green-600">RK Defence Academy</span> provides disciplined training for SSC GD,
                            AGNIVEER, CISF, CRPF and RPF with experienced trainers and structured programs.
                        </p>
